          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav.Item>
              ...
              <NavDropdown title="Innovation Labs" id="collasible-nav-dropdown1">
                <NavDropdown.Item className="text-primary" target="_self" href="/research">Research & Development</NavDropdown.Item>
                <NavDropdown.Item className="text-primary" target="_self" href="/productdev">Product Development</NavDropdown.Item>
              </NavDropdown>
              ...
              <NavDropdown title="Services" id="collasible-nav-dropdown2">
                <NavDropdown.Item className="text-primary" target="_self"  href="/consulting">Consulting</NavDropdown.Item>
                <NavDropdown.Item className="text-primary" target="_self" href="/outsourcing">Outsourcing</NavDropdown.Item>
              </NavDropdown>
              <Nav.Item>
